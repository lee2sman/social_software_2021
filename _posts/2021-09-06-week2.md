...
![PDP-11 mainframe computer]({{"assets/img/central-phone-room.jpg" }})
...
IRC or Internet Relay Chat is over 30 years old. It predates the graphical web. It is an ancestor of our current chat software such as Slack or Discord, but it was decentralied and non-commercial. It's still in use today, though now there are desktop applications you can use to connect.

![AOL chat rooms]({{"assets/img/aol.gif" }} )  
*AOL chat rooms, circa 1996*

In the 90s, America Online sent out free floppy disks and DVDs and made their own platform of chat rooms, forums and other services. Chat rooms were listed with general category and sometimes topic names.
